...
const Checkout = () => {
	...
	return (
		<>
			<div>
				<div className={`hidden lg:block fixed top-100 left-0 w-1/2 h-full ${isDark ? 'bg-black' : 'bg-white'} `} />
				<div className={`hidden lg:block fixed top-100 right-0 w-1/2 h-full ${isDark ? 'bg-neutral-900' : 'bg-gray-100'} `} />
