...
import Basket from '../restaurant/Basket';
...
const Notification = ({message}) => {
	...
	return (
		<>
			...
			<div aria-live='assertive' className='mt-10 fixed inset-0 flex items-end px-4 py-6 pointer-events-none sm:p-6 sm:items-start'>
						...
						<div className='max-w-sm w-full bg-white shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden'>
							<div className='p-4'>
								<div className='flex items-start '>
									{state.basket.message === 'removed from basket' ? (
									...
									<div className='ml-3 w-0 flex-1 pt-0.5'>
										...
										{state.basket.message !== 'removed from basket' && <p className='mt-1 text-sm text-gray-500'>you can see the order in your basket</p>}
									</div>
