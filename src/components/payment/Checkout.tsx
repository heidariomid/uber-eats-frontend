					...
					<div className='bg-white shadow-lg rounded-lg mt-9'>
						...
						<div className='bg-gray-100 text-center px-5 py-6'>
							...
							<form className='space-y-3'>
								...
								<button type='submit' className='font-semibold text-sm inline-flex items-center justify-center px-3 py-2 border border-transparent rounded leading-5 shadow transition duration-150 ease-in-out w-full bg-indigo-500 hover:bg-indigo-600 text-white focus:outline-none focus-visible:ring-2'>
									Pay Now
								</button>
							</form>
						</div>
